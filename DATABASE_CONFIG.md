...
```env
DATABASE_URL="postgresql://squarecloud:ZpaXsUrPD0S8apEMoWnh8qqd@square-cloud-db-ec92e0642b914258b5fff2d991c218be.squareweb.app:7017/ecommerce"
```
...
```env
DATABASE_URL="postgresql://squarecloud:ZpaXsUrPD0S8apEMoWnh8qqd@square-cloud-db-ec92e0642b914258b5fff2d991c218be.squareweb.app:7017/ecommerce?sslmode=require"
```
